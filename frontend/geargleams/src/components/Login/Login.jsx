...
const Login = () => {
  ...
  return (
<div className="h-screen bg-cover" style={{backgroundImage: `url(${backgroundImage})`, backgroundSize: "cover", backgroundPosition: "center"}}>

      <div className="h-full bg-opacity-50 bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
